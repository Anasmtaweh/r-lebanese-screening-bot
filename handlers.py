...
async def on_admin_help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "   👉 `/list left` (Users who left the group voluntarily)\n\n"
        "   👉 `/list banned` or `/list kicked` (Users who were manually kicked/banned)\n\n"
        ...
        "• `/pb <user_id>` - Start a 24-hour probation for users who blocked the bot.\n\n"
