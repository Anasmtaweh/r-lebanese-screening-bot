...
# Blocked-user probation: 24 hours = 86400 seconds.
PROBATION_BLOCKED_TIMEOUT_SECONDS = int(os.getenv("PROBATION_BLOCKED_TIMEOUT_SECONDS", "86400"))
...
STATUS_PROBATION_BLOCKED = "PROBATION_BLOCKED"
